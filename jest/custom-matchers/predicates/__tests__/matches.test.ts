...
describe('matches returns true with', () => {
  describe.each([
    ...
    ['The quick brown fox', /quick/, 'a received string that matches the provided regular expression'],
    [
      'The quick brown fox',
      new RegExp('quick'),
...
describe('matches returns false with', () => {
  describe.each([
    ...
    ['The quick brown fox', /jumped/, 'a received string that does not match the provided regular expression'],
    [
      'The quick brown fox',
      new RegExp('over'),
