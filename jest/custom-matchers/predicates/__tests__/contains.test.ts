...
describe('contains() returns false with', () => {
  test.each([
    ...
    [['jest', 'is', 'fun'], 'for testing', 'an array of strings that does not contain the expected string'],
    [[{ id: 1 }, { id: 2 }], { id: 22 }, 'an array of objects does not contain the expected object'],
    [
      [
        [1, 2],
        [3, 4],
